...
// Gets the size the font was created with.
...
// Draws a string on the screen. The base line is determined by pos.
void txt_DisplaySDFString( const char* utf8Str, float size, Vector2 pos, Color clr, HorizTextAlignment hAlign, VertTextAlignment vAlign,
