...
enum ColliderType {
	...
	CT_HALF_SPACE,
	CT_LINE_SEGMENT,
	CT_ORIENTED_BOX, // rotatable box, if it will never rotate prefer CT_AABB instead
	NUM_COLLIDER_TYPES
};
...
//  Returns if there is any overlap and if there is puts the separation into outSeparation.
