...
#define GLC(c,x) do { (x); (c)=CheckAndLogError( __FILE__":"TOSTRING(__LINE__) ); } while(0,0)
#define GLDR(d,r,x) do { (r)=(x); } while(0,0)
#define GLDC(d,c,x) do { (x); (c)=CheckAndLogError( d" "__FILE__":"TOSTRING(__LINE__) ); } while(0,0)
#define GLRC(r,c,x) do { (r)=(x); (c)=CheckAndLogError( __FILE__":"TOSTRING(__LINE__) ); } while(0,0)
#define GLDRC(d,r,c,x) do { (r)=(x); (c)=CheckAndLogError( d" "__FILE__":"TOSTRING(__LINE__) ); } while(0,0)
#endif
